...
def extract_patches_from_dir(directory, patchsize, 
                             smoothing=None, overlap_allowed=0.9,
...
image = cv2.imread('/home/travis/data/data1/messidor/crop/20051020_44923_0100_PP.jpg')
patch_shap = [175,175]
patches = extract_patches(image, patch_shap)
destination = '/home/travis/data/patch_test/'
num = len(patches)
for i in range(num):
    # i = 1
    cv2.imwrite(destination+ str(i) +'.jpg', patches[i])